...
namespace phamhai\roxymce\assets;
...
class RoxyMceAsset extends AssetBundle {
	...
	public function init() {
		...
		$this->depends    = [
			...
			'phamhai\roxymce\assets\FontAwesomeAsset',
			'phamhai\roxymce\assets\BootstrapTreeviewAsset',
			'phamhai\roxymce\assets\LazyLoadAsset',
			'phamhai\roxymce\assets\FancyBoxAsset',
			'phamhai\roxymce\assets\ContextMenuAsset',
		];
		$this->css        = [
